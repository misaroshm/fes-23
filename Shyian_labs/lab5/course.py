class Course:
    ...
    def add_student(self, name: str):
        ...
        """
        self.student_added.append(name)
        print(f"Student {name} is added to {self.title} course!")

    def remove_student(self, name: str) -> str:
        """
        ...
        """
        self.student_added.remove(name)
...
class Seminar:
    ...
    def add_comment(self, message: str, title: str) -> str:
        """
        ...
        """
        print(f"Comment to {title}: {message}")
